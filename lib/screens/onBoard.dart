...
//      ),
      pages: [
        PageViewModel(
          title: "Tidey",
          body:
              "Tidey is a marine weather clock designed to be displayed on the wall in your home or on your boat.",
        ...
        PageViewModel(
          ...
          body:
              "Tidey includes rotating gauges for tides, waves, wind, temperature, barometric pressure, water temperature, sunrise, and moon rise.",
        ...
        PageViewModel(
          title: "Ships Bells",
          body:
              "Tidey rings an authentic brass ship bell on the hour or following the traditional marine watch code.  Set Alarms or Timers to sound the fog horn.",
          image: _buildImage('OnBoard3A.png'),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Tap and Swipe",
