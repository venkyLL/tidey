...
//                  ),
                  ...
                  helpTile(context, "What is Continuous Marquee Enabled?",
                      "When enabled the Marquee will continue to cycle (Must be in Landscape Mode on tablet.  When disabled the Marquee will cycle twice at the top of the hours"),
                  helpTile(context, "What is Show Weather in Marquee?",
                      "When enabled tide and forecast data will be included in Marquee, when disabled only Marquee Text will be included."),
                  helpTile(context, "What is Marquee Text?",
                      "This text will appear at the start of each Marquee cycle."),
                  helpTile(context, "Why am I not seeing the Marquee?",
                      "The Marquee is only shown on tablets in landscape mode. The marquee is only displayed at the top of the hour unless Continuous Marquee is enabled."),
                  helpTile(context, "What are Four Gauge Images?",
                      "These images will be displayed in the gauges after all the weather gauges have completed.  You can upload any image from the photo gallery."),
